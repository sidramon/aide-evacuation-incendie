...
const questions: Question[] = [
  ...
  { id: "1G", text: "Si non, serait-il en mesure de le faire avec l'aide d'une autre personne ?", skipIf: answers => answers["1F"]?.toLowerCase() !== "non" || answers["1E"]?.toLowerCase() === "oui" },
...
export function interpretResponses(): void {
    ...
    if (answers['3D'] === 'non') {
      actions.add('Équipement lumineux à prévoir');
      hearingIssue = true;
      if (resident.colorCode === 'vert') resident.colorCode = 'jaune';
    }
